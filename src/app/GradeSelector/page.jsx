          ...
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-lg">
            ...
            {date && time && unit && (
              <div className="mt-6 p-4 bg-gray-50 rounded-lg shadow-sm">
                ...
                <p className="text-black"><strong>Selected Date:</strong> {date}</p>
                <p className="text-black"><strong>Selected Time:</strong> {time}</p>
                <p className="text-black"><strong>Selected Unit:</strong> {unit}</p>
              </div>
            )} */}
